...
class FeaturesGenerator:
    ...
    def setForeignKeyProps(self):
        ...
        resValues = self.sourceDF["Foreign Key"].apply(FeaturesGenerator.destructureKeyRef)
    ...
    def setTypeIndex(self):
        self.sourceDF["Json Type"] = self.sourceDF["Data Type"].apply(NameSyntax.JSONType)
    ...
    def setOptions(self):
        self.sourceDF["Option List"] = self.sourceDF["Option String"].map(FeaturesGenerator.splitOptions)
        return self.sourceDF
